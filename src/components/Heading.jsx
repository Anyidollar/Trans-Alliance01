...
const Heading = () => {
  return (
    <div className="flex flex-wrap mb-10 justify-center md:w-full md:mt-20">
      <div className="flex flex-col justify-start max-sm:p-10 md:p-10">
        <p className="text-sm text-yellow-600 md:mr-auto md:-mb-4">
          Simplified cross-border payment
        </p>
        <p className="text-4xl md:text-6xl lg:text-8xl text-white md:mt-2 md:mb-3 text-center">
