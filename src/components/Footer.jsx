  ...
  return (
    <div className="flex flex-col p-4 sm:p-8 w-full">
      <div className="flex flex-col md:flex-row justify-between mb-8">
        ...
        <div className="flex flex-col mb-8 md:mb-0">
          <div className="text-lg md:text-xl font-semibold mb-4">Solutions</div>
          <div>Money Out</div>
          <div>Money In</div>
        </div>
        <div className="flex flex-col mb-8 md:mb-0">
          <div className="text-lg md:text-xl font-semibold mb-4">Sectors</div>
        ...
        <div className="flex flex-col">
          <div className="text-lg md:text-xl font-semibold mb-4">Other</div>
          <div>About Us</div>
