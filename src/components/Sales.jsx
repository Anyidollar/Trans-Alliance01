      ...
      <div className="md:w-1/2 mt-8 md:mt-0">
        <section className="mx-1">
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <div className="mb-12 font-DMSans">
              <h2 className="text-2xl">Speak to sales</h2>
            </div>
            <form className="lg:mx-20 font-DMSans">
              <div className="mb-4">
                <label className="block mb-2" htmlFor="email">
                  Email
                </label>
                <input
                  className="w-full lg:px-3 py-2 border rounded-lg"
                  type="email"
                  id="email"
                  name="email"
                  required
              ...
              <div className="flex items-start mb-4">
                ...
                <p className="text-sm text-gray-700 font-DMSans">
                  ...
                  my personal data in accordance with its <a href="#"><u>Privacy Policy</u></a>.
                </p>
              </div>
